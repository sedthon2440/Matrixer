...
Zed_Vip = (7291869416)
Zed_Dev = (7291869416)
zchannel = {"@veevvw", "@sedthon_help", "@BDB1B"}
...
async def mybot(): 
    ...
    if bot_name.startswith("مسـاعـد"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "BiLaL")
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", f"- بـوت مـاتركـس المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
            await asyncio.sleep(3)
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/2345e444d4e27a1bda73e.jpg",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس مـاتركـس الخاص بك .. بنجاح 🧸♥️**",
